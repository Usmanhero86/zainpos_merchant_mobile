...
import 'package:zainpos_merchant_mobile/screens/banks/bank_list_empty.dart';
import '../../services/models/response_model/bank_list_model.dart';

class EmptyBankSelection extends StatefulWidget {
  final Function(Bank)? onBankSelected;

  const EmptyBankSelection({super.key, this.onBankSelected});

  @override
  State<EmptyBankSelection> createState() => _EmptyBankSelectionState();
}

class _EmptyBankSelectionState extends State<EmptyBankSelection> {
